...
lai_parallel_exports <- function() {
  c(
    "run_one_rep", "run_study1_rep", "run_study2_rep", "run_study3_rep",
    "simulate_study1", "simulate_study2", "simulate_study3",
    ...
    "condition_includes_tempered_eiv", "fit_tempered_eiv_dual_set", "lai_truth", "make_covu",
    "make_study2_cluster_sizes", "make_study3_cluster_sizes", "fixed_params",
    "safe_lmer", "empty_stage1_diagnostics", "get_stage1_diagnostics",
    "get_closed_form_corrected_scores", "default_re_design", "make_eb_output_row",
